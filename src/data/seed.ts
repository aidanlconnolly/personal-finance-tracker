...
export const SEED_STATE: AppState = {
  ...
  lots: [
    { id: "lot-aapl-1", ticker: "AAPL", shares: 25, costBasis: 142.5, purchaseDate: "2023-03-15", currentPrice: 211.0 },
    { id: "lot-aapl-2", ticker: "AAPL", shares: 10, costBasis: 188.0, purchaseDate: "2024-11-02", currentPrice: 211.0 },
    { id: "lot-nvda-1", ticker: "NVDA", shares: 8, costBasis: 118.0, purchaseDate: "2025-12-10", currentPrice: 135.0 },
    { id: "lot-nvda-2", ticker: "NVDA", shares: 5, costBasis: 890.0, purchaseDate: "2023-06-01", currentPrice: 135.0 },
    { id: "lot-vti-1", ticker: "VTI", shares: 40, costBasis: 198.0, purchaseDate: "2022-08-20", currentPrice: 268.0 },
    { id: "lot-msft-1", ticker: "MSFT", shares: 15, costBasis: 310.0, purchaseDate: "2023-01-12", currentPrice: 452.0 },
  ],
  recurringExpenses: [
    { id: "rec-rent", label: "Rent", amount: 2400, dayOfMonth: 1 },
    { id: "rec-groceries", label: "Groceries", amount: 700, dayOfMonth: 1 },
    { id: "rec-utilities", label: "Utilities + internet", amount: 250, dayOfMonth: 1 },
  ],
  oneOffExpenses: [
